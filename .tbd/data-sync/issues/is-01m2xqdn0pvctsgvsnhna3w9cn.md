...
2026-09-19 audit: held per AGENTS.md instruction not to retry the same number-without-Value::from pattern as reverted uro-nuhn. Resume only with new profiling evidence and an explicit different hypothesis; this is not the next ready memory cut.
