...
updated_at: 2026-09-19T23:59:33.039Z
---
...
- 2026-09-19: Cursor left this bead's scope. Maintainer use applies, as it did for Gemini CLI (Decision 28). Cursor has a dedicated plan (docs/project/specs/active/plan-2026-09-19-cursor-dialect.md) and epic uro-hdoq: model and provider are first-class facets; it is not milestone 0.1 and not the Phase 2 Pi and Gemini slice.
...
- SQLite-backed agents (OpenCode, Hermes Agent, Goose, Kilo) wait for database input (Decision 20, Phase 3 at the earliest). A named Cursor state-store adapter is tracked on uro-hdoq, not here.
